...
try {
  ...
  ; (() => {
    ...
    const addTranscriptionMessage = () => {
      ...
      transcribeOn.style.background = "white";
      transcribeOn.style.color = "grey";
    ...
    const turnCaptionsOn = () => {
      // const captionsButtonOn = xpath(`//div[contains(text(), 'Turn on captions (c)')]`, document);
    ...
    const turnCaptionsOff = () => {
      // const captionsButtonOff = xpath(`//div[contains(text(), 'Turn off captions (c)')]`, document);
    ...
    const XPATH_SELECTOR_PARTICIPANTS = `//div[contains(text(), 'Show everyone')]`

    const XPATH_SELECTOR_CHAT = `//div[contains(text(), 'Chat with everyone')]`;
